...
| **Gender Pension Gap (GPG)** | Unadjusted GPG of ~27–30% driven by part-time employment, wage gaps, and career breaks, partially mitigated by *Mütterrente*. | Haan et al. (*Eur. Econ. Rev.* 2021) \cite{haan2021gender}; DRV Rentenatlas 2024/2025 \cite{drv2025rentenatlas} | Native Female: **€2,045/mo** vs. Male: **€2,178/mo**; Ukr Refugee Female: **€768/mo** vs. Male: **€894/mo** | **Disaggregated Sensitivity**: Full 3-way gender view incorporating § 56 SGB VI childcare points (+3 EP) and 21.5 vs. 18.5 yr longevity horizons. |
